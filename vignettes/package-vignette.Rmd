...
Finally, the sum_sor function will run two for loops to sum up the SOR scores for each team. The function then creates a new data frame that contains two columns, the name of the team, and their total SOR score. This is the data frame that is returned by the function. 
